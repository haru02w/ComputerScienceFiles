...
{	
	...
	if (sal_func<500)
	{
		printf("\nO salário do funcionário é: %.2f", sal_func);
 		printf("\nO salário com reajuste é: %.2f", sal_func+sal_func*0.15);
 	
	}
	else if (sal_func>=500 && sal_func<=1000)
	{
		printf("\nO salário do funcionário é: %.2f", sal_func);
 		printf("\nO salário com reajuste é: %.2f", sal_func+sal_func*0.10);
 	}	
	else 
	{
		printf("\nO salário do funcionário é: %.2f", sal_func);
 		printf("\nO salário com reajuste é: %.2f", sal_func+sal_func*0.05);
 	}	
